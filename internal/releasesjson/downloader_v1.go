...
import (
	...
	"github.com/hashicorp/go-releases/generated/models"
	"github.com/hashicorp/hc-install/internal/httpclient"
)

func (d *Downloader) DownloadAndUnpack_v1(ctx context.Context, pv *models.ProductReleaseResponseV1, binDir string, licenseDir string) (zipFilePath string, err error) {
	if len(pv.Builds) == 0 {
